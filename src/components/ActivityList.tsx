    ...
    return (
        <>
            ...
            {state.activities.map((activity) => (
                <div key={activity.id} className=" mx-auto bg-slate-200 p-5 flex  shadow-lg justify-between ">
                    <div className="space-y-3 relative justify-between">
                        <p
                            className={`absolute uppercase text-white -top-8 -left-8 px-10 py-2 ${
                        ...
                        <p className=" text-4xl font-black capitalize text-lime-500 "> {activity.calories} calorias</p>
                    </div>
